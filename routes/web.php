...
use App\Http\Controllers\Auth\LoginControllerler;
...
Route::get('/DangKy', [RegisterController::class, 'index'])->name('DangKy');
Route::get('/DangNhap', [LoginControllerler::class, 'index'])->name('DangNhap');
