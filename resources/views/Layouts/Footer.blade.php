    ...
    <div class="bg-primary text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5 px-lg-5">
            <div class="row g-5">
                <div class="col-md-6 col-7 col-lg-3">
                    <h5 class="text-white mb-4">Thông tin liên lạc</h5>
                    <p><i class="fa fa-map-marker-alt me-3"></i>địa chỉ</p>
                    <p><i class="fa fa-phone-alt me-3"></i>số điện thoại</p>
                    <p><i class="fa fa-envelope me-3"></i>songyen.psy@gmail.com</p>
                ...
                <div class="col-md-6 col-5 col-lg-3">
                    <h5 class="text-white mb-4">Liên kết</h5>
                    <a class="btn btn-link" href="">Về chúng tôi</a>
                    <a class="btn btn-link" href="">Liên hệ</a>
                    <a class="btn btn-link" href="">Sự kiện</a>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <p>Hãy liên hệ với chúng tôi bằng cách để lại email ở đây</p>
                    <div class="position-relative w-100 mt-3">
                        <input class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="text" placeholder="Nhập email tại đây" style="height: 48px;">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Doanh nghiệp xã hội tư vấn và đào tạo Song Yến</a>, All Right Reserved. 
                    </div>
                </div>
            </div>
        </div>
