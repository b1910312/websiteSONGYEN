        ...
        <div class=" my-5 py-5 px-lg-5">
            <div class="row g-5 py-5">
                <div class="col-12 text-center">
                    <h1 class="text-white animated zoomIn">Trắc nghiệm</h1>
                    <hr class="bg-white mx-auto mt-0" style="width: 90px;">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Hướng nghiệp</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Trắc nghiệm</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="py-5 mb-5 bg bg-white ">
        <div class="row w-100">
            <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h2 class="mt-2">Những bài trắc nghiệm của chúng tôi về hướng nghiệp</h2>
        ...
        <div class="row w-100">
            <div class="col-lg-3 col-md-6 col-12 text-center card p-3 wow fadeInUp">
                <div class="uk-margin w-100">
                    <h4 >Tìm kiếm bài trắc nghiệm</h4>
                ...
                <hr>
                <div class="container">
                    <h5 >Bạn muốn tìm bài trắc nghiệm</h5>
                    <div class="row w-100 my-3 mt-4">
                        <div class="col-6">
                            <button class="btn w-100 btn-outline-primary active">Miễn phí</button>
                        </div>
                        <div class="col-6">
                            <button class="btn w-100 btn-outline-primary">Trả phí</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-4 portfolio-item  first wow zoomIn" data-wow-delay="0.1s">
                        <div class="position-relative rounded overflow-hidden">
                            ...
                            <div class="portfolio-overlay">
                                <a class="btn btn-light" href="{{ route('HN_ChiTietTest', ['id' => $item['id']]) }}"><i
                                ...
                                <div class="mt-auto">
                                    ...
                                    <a class="h5 d-block text-white mt-1 mb-0"
                                        href="{{ route('HN_ChiTietTest', ['id' => $item['id']]) }}">{{ $item['BV'] }}</a>
